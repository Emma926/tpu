...
out_path = os.path.join(root, 'outputs_trace')
...
configs = {
  'resnet':(1024, 1000, 1000),
  'densenet':(1024, 1000, 1000),
  'mobilenet':(1024, 1000, 1000),
  'squeezenet':(1024, 1000, 1000),
  'retinanet':(64, 1000, 1000),
